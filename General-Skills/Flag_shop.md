...
```
Integer overflow mogelijk waardoor total_cost negatief wordt.
omdat total_cost negatief is, is deze waarde kleiner dan account_balance (1100)
de total_cast wordt afgetrokken van account_balance maar -- wordt + waardoor account_balance opgehoogd wordt
```
